...
/**
 * Base class for a chat message, posted by a player,
 * in a game, or in a channel.
 */
@Index(keysOf<AbstractChatMessage>()('createdAt')) // TODO replace with: { field: 'createdAt', order: 'DESC' }, once this issue is solved: https://github.com/typeorm/typeorm/issues/3336
export default abstract class AbstractChatMessage
{
...
const serializationShouldHideContent = (chatMessage: AbstractChatMessage, groups?: string[]): boolean => {
