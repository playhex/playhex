 ...
 * Conditional moves
 */
const conditionalMovesStateRed = ref<ConditionalMovesState>(createConditionalMovesState(0));
const conditionalMovesStateBlue = ref<ConditionalMovesState>(createConditionalMovesState(1));
...
const enableConditionalMoves = (myIndex: 0 | 1) => {
    ...
    conditionalMovesState.value = myIndex === 0
        ? conditionalMovesStateRed.value
        : conditionalMovesStateBlue.value
    ;

    editor.value = new ConditionalMovesEditor(conditionalMovesState.value);
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div v-else-if="conditionalMovesState && editor">
                            <button class="btn btn-success" @click.prevent="disableConditionalMoves">Disable</button>

                            <p>
                                Has changes: {{ conditionalMovesState.hasChanges ? 'yes' : 'no' }}
                                <br>
                                Selected line: {{ conditionalMovesState.selectedLine.join(' ') }}
                                <br>
                                Submitted lines count: {{ conditionalMovesState.conditionalMoves.tree.length }}
                            </p>
                            ...
                            <code><pre>{{ JSON.stringify(conditionalMovesState.conditionalMovesDirty.tree, undefined, 2) }}</pre></code>
                        </div>
                    </div>
                </div>
            </div>
