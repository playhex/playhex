    ...
    <div class="container-fluid my-3">
        ...
        <div class="play-buttons row mb-4 g-3">
            <div class="col col-sm-6 col-md-4">
                <button type="button" class="btn w-100 btn-primary" @click="() => create1vOfflineAIAndJoinGame()"><BIconRobot class="fs-3" /><br>New game vs AI</button>
            </div>
        </div>
            ...
            <div class="col col-sm-6 col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <router-link :to="{ name: 'play-vs-offline-ai' }" class="stretched-link">Continue game vs {{ currentGame.players.find(p => p.isBot)?.pseudo ?? 'AI' }}</router-link>
                    </div>
                </div>
            </div>
        </div>
