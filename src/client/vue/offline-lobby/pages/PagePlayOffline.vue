...
<template>
    ...
    <div class="game-menu">
        <router-link class="btn btn-outline-primary" :to="{ name: 'offline-lobby' }">Back to menu</router-link>
        <button class="btn btn-outline-warning" @click="rematch">Restart</button>
    </div>
</template>
