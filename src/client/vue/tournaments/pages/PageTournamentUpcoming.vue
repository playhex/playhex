...
const formatStartsAtDate = (date: Date): string => {
                    ...
                    <div class="card h-100 shadow-sm">
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                <time :datetime="tournament.startOfficialAt.toISOString()" class="ms-2">
                                    {{ formatStartsAtDate(tournament.startOfficialAt) }}
                                </time>
                            </h5>
                            <p class="text-secondary">
                                <small><AppCountdown :date="tournament.startOfficialAt" /></small>
                            </p>
                            <p class="card-text">{{ $t('checkin_opens_time_before', { time: duration(tournament.checkInOpenOffsetSeconds) }) }}</p>
                        </div>
                    </div>
