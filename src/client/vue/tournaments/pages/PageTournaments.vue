...
import { getActiveTournamentGames } from '../../../../shared/app/tournamentUtils';
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text lead">
                                ...
                                {{ $t('n_playing_games', { count: getActiveTournamentGames(tournament).length }) }}
                            </p>
                            <p class="card-text">
                                <router-link
