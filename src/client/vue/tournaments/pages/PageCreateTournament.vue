...
tournament.value.startOfficialAt.setHours(20, 0, 0, 0);

if (tournament.value.startOfficialAt < new Date()) {
    tournament.value.startOfficialAt.setDate(tournament.value.startOfficialAt.getDate() + 1);
}
