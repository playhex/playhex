...
import { apiDeleteTournamentBannedPlayer, apiGetTournamentBannedPlayers, apiPatchTournament, apiPostIterateTournament, apiPostStartTournament, apiPutTournamentBannedPlayer } from '../../../apiClient.js';
    ...
    <div class="container my-3">
        ...
        <template v-if="tournament && 'created' === tournament.state">
            ...
            <ul>
                ...
                >
                    <button @click="banPlayer(subscription.player)" class="btn btn-sm btn-outline-danger me-2">Ban</button>
