...
type FeaturedGamesEvents = {
    featuredGamesUpdated: (featuredGames: HostedGame[]) => void;
};
 ...
 */
@Service()
export class FeaturedGames extends TypedEmitter<FeaturedGamesEvents>
{
    /**
    ...
    onGameStarted(hostedGame: HostedGame): void
    {
        ...
        if (this.featuredGames.length < MAX_FEATURED_GAMES) {
            ...
            this.emit('featuredGamesUpdated', this.featuredGames);
            return;
        }
