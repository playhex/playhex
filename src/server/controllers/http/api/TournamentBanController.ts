...
import { AuthenticatedPlayer, mustBeTournamentHost } from '../middlewares.js';
...
export default class TournamentBanController {
    ...
    async getBannedPlayers(
        ...
        mustBeTournamentHost(tournament, authenticatedPlayer);
    ...
    async putBannedPlayer(
        ...
        mustBeTournamentHost(activeTournament.getTournament(), authenticatedPlayer);
