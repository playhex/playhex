import { Body, Get, HttpError, JsonController, NotFoundError, Param, Patch, Post, Put, QueryParam } from 'routing-controllers';
...
export default class TournamentController
{
    ...
    async getActiveTournaments(
        ...
        return this.tournamentRepository.getActiveTournaments(playerUuid ?? null);
    }
