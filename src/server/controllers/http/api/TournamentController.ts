...
export default class TournamentController
{
    ...
    @Delete('/api/tournaments/:slug/subscriptions')
    async deleteSubscription(
        ...
        return await this.tournamentRepository.unsubscribe(tournament, player);
    }
    ...
    async getBannedPlayers(
        ...
        return await this.tournamentRepository.getBannedPlayers(tournament);
    }
    ...
    async putBannedPlayer(
        ...
        return await this.tournamentRepository.banPlayer(activeTournament, player);
    }
    ...
    async deleteBannedPlayer(
        ...
        return await this.tournamentRepository.unbanPlayer(activeTournament, player);
    }
    ...
    async postSartTournament(
        ...
        try {
            activeTournament.startNow();

            return await this.tournamentRepository.save(activeTournament.getTournament());
        } catch (e) {
