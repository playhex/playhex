...
export default class LadderService
{
    ...
    async challenge(
        ...
        if (liveTimeControlType !== null) {
            const liveRefusal = canProposeLive(liveTimeControlType, boardsize);
    ...
    async answerLiveProposal(challengePublicId: string, player: Player, accept: boolean): Promise<LadderChallenge>
    {
